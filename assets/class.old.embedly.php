...
function embed($url)
{
    ...
    preg_match($regexImg, $url, $img);

    # check for direct video URL
    $regexVid = '/https?:\/\/\S+(?:mp4|webm|ogg)\b/';
    preg_match($regexVid, $url, $vid);
 ...
 * @link   https://github.com/embedly/embedly-php
 */ 
class embedly {
     ...
     * @var string
     */
    protected $key = '09eb1c3478694dabad9e7fa22ac794c2';
